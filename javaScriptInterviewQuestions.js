...
String - It represents a series of characters and is written within quotes. A string can be represented using a single or a double quote.
...
Null - It represents a none-existent or a invalid value.
var z = null;
...
Note - To avoid hoisting, we can run javascript in strict mode by using “use strict” on top of the code:
"use strict";
...
let result = "5" * 2; // 10
let result = "5" / 2; // 2.5
if ("") { console.log("This won't run"); } // Empty string is falsy
if (0) { console.log("This won't run"); } // Zero is falsy
...
if ([]) { console.log("This will run"); } // Empty array is truthy
if ({}) { console.log("This will run"); } // Empty object is truthy
if (null) { console.log("This won't run"); } // null is falsy
if (undefined) { console.log("This won't run"); } // undefined is falsy
if (NaN) { console.log("This won't run"); } // NaN is falsy
...
Static Typing:
Variable have types, values have types and variable cannot change type.
Dynamic Typing:
Variable have no types, values have types and variable change type dramatically.
